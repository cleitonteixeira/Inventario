...
class SolicitacaoClass {
    private $idSolicitacao, $idEquipamento, $idSolicitante, $idEstoque, $idUnidade, $Unidade, $Sequencial, $dSolicitacao, $Tipo, $dEnvio, $dConclusao, $Equipamento, $Categoria, $Solicitante, $Estoque, $Regiao;
